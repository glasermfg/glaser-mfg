            ...
            <Row>
              <Col lg="12">
                ...
                <p>
                  ...
                  water using appliances and fixtures. When combined with soap,
                  the minerals form soap curds or scum causing dry and itchy
                  skin, lifeless hair, and dull laundry.
                </p>
                <p>
                  We have a wide selection of softeners, and all of our products
                  can be customized to provide the ultimate water solution.
                  You'll enjoy fast, friendly & knowledgeable service &
                  competitive prices.
                </p>
                ...
                <p>
                  ...
                  water you can depend on right from your tap. The RO System not
                  only removes tiny particles suspended in water; it also
                  removes contaminants that are dissolved in water that
                  conventional filters cannot remove. Easily installed in any
                  home, either under the kitchen sink or in the basement below;
                  this system provides clean, great tasting water to a dedicated
                  faucet at your kitchen sink.
                </p>
                <p>
                ...
                <p>
                  ...
                  process as nature to provide drinking water that is completely
                  Safe, Clean, and Fresh. In nature, the sun produces UV rays,
                  which have a germicidal effect on disease causing pathogens in
                  water. When these contaminants are exposed to UV light, they
                  are rendered harmless, and the output water is considered
                  disinfected for human consumption. UV technology is proven to
                  control microbiological (bacteria & virus) issues in water
                  including E. coli, Cryptosporidium and Giardia lamblia. The UV
                  purifier doesn't add or remove anything from the water and is
                  extremely cost effective. UV purification affects waterborne
                  contaminants and disease-causing pathogens with a 99.9% kill
                  rate or better. The result is high quality water that is
                  clean, clear, pure, and safe drinking water for your family.
                </p>
                <p>
                  We offer 6 to 30 GPM UV Systems with LED display showing lamp
                  life remaining and audible indicator. We also offer NSF UV
                  systems and bulbs
                </p>
                ...
                <ul>
                  ...
                  <li>
                    ...
                    disease-causing pathogens with a 99.9% kill rate or better.
                  </li>
                </ul>
                <h3>Iron Filtration and Sulfur Systems</h3>
                <p>
                  Our Iron filtration systems work by using a proprietary blend
                  of media and filtration processes to reduce contaminants such
                  as iron, sulfur, arsenic, and others. Iron filtration systems
                  can reduce the amount of iron found in water throughout your
                  home, removing buildup, protecting water-using appliances, and
                  reducing staining in your sinks, tubs, and laundry.
                </p>
                <p>Some of the Benefits of an Iron filter include:</p>
                <ul>
                  <li>
                    Removal of poor taste, odours, dirt, rust, organic
                    contaminants, such as herbicides, pesticides, and industrial
                    chemicals
                  </li>
                  <li>
                  ...
                  <li>
                    Experience the joy of Stain and Sulphur-Free Laundry, Sinks
                    and Appliances.
                  </li>
                  <li>
                    Improve Water Pressure, Increased Flow, and longer equipment
                    Life
                  </li>
                </ul>
                ...
                <ul>
                  <li>
                    Removal of sediment, bad tastes, stains, colour, and odours.
                  </li>
                  <li>Removes sediment and turbidity as small as 20 microns</li>
                  <li>
                ...
                <p>
                  We carry a wide variety of replacement components of Filters,
                  Filter housings, Ultraviolet Sterilizers Bulbs and sleeves, RO
                  Membranes, Injection Pumps, Valves, fittings, and other
                  accessories. Call our order desk today for pricing &
                  availability.
                </p>
                ...
                <p>
                  ...
                  scheduled maintenance plan to ensure proper, clean filtration
                  and drinking water. Many products do require servicing on a
                  regular basis and by registering your equipment, you leave the
                  guesswork to us. We will contact you when service is required.
                </p>
                <h3>Water Testing</h3>
                <p>
                ...
                <h3>Installations</h3>
                <p>
                  Once we decide on the best course of action for your home, the
                  next step is to schedule a professional installation and your
                  initial setup. We offer a full range of solutions from Water
                  softeners, Reverse Osmosis, Ultraviolet Sterilizers, Whole
                  Home Filters, Iron Filters, or something else, and our
                  qualified technicians will come to your home to ensure proper
                  installation, setup and programming & will help to answer any
                  questions you might have about your new system.
                </p>
              </Col>
            </Row>
          </Container>
